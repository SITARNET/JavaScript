...
// var letter1 = "#";
// var letter2 = " ";
// for (var i = 0; i < (size * (size + 1)); i++) { // цикл от 0 до (8 * (8 + 1)) = 72
//     if (i % (size + 1) === 0) { // если остаток деления = 0, каждые 8 символов
//         line += '\n'; // то перенос строки
//     } else if (i % 2 === 0) { // если чётное
//         line += letter1; // то выводим решётку
//     } else { // если не чётное
//         line += letter2; // то выводит пустую строку
//     }
// }
// console.log(line);
...
// var size = 8;
// var result = '';
// for (var i = 0; i < size; i++) { // цикл от 0 до 8 (size) столбец
//     for (var j = 0; j < size; j++) { // цикл от 0 до 8 (size) строка
//         if (i % 2 !== 0) { // если не чётная строка 1, 3, 5, 7
//             result += (j % 2 === 0) ? ' ' : '#' // если в строке чётное = ' ', а если не чётное колличество символов, то '#'
//         } else { // если чётная строка 2, 4, 6, 8
//             result += (j % 2 === 0) ? '#' : ' ' // если в строке чётное = '#', а если не чётное колличество символов, то ' '
//         }
//     }
//     result += "\n"; // в конце каждой строки перенос
// }
// console.log(result);
...
//     nums = parseInt(nums / 10);   // Переходим к следующей цифре в числе. Возвращает целое число.
// }
// console.log(result);
...
// var n = prompt("Введите простое число: ", n);
//
// nextPrime:
